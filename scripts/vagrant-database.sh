...
run_in_vagrant -c "sudo chown bahmni:bahmni /packages/build/search_config/migrations"
run_in_vagrant -c "sudo su - bahmni -c 'sudo cp -r /Project/search-config/migrations/* /packages/build/search_config/migrations/'"
