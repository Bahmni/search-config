...
public class PatientRequestMapperTest {
    ...
    public void shouldMapNAmeFromCsvRowWhenAllPartsOfNameExist() throws ParseException {
        ...
        PatientProfileRequest patientProfileRequest = new PatientRequestMapper().mapPatient(csvRow, null, null);
    ...
    public void shouldMapOldCaseNumberAsPatientIdentifier() throws ParseException {
        ...
        PatientProfileRequest patientProfileRequest = new PatientRequestMapper().mapPatient(csvRow, csvRow.oldCaseNo, null);
        Patient patient = patientProfileRequest.getPatient();
    ...
    public void shouldMapPersonNameUuidFromPersonResponse() {
        ...
        PatientProfileRequest patientProfileRequest = new PatientRequestMapper().mapPatientForUpdate(csvRow, patientResponse, null);
    ...
    public void shouldMapBirthDate() throws ParseException {
        ...
        csvRow.age = "22m 400d";
        patientProfileRequest = new PatientRequestMapper().mapPatient(csvRow, null, null);
